...
static SEQUENCE sequences[] = {
    ...
    { "load.s.pri %1!push.pri!load.s.pri %2!pop.alt!",
        "load.s.pri %2!load.s.alt %1!", seqsize(4, 2) - seqsize(2, 2) },
    { "load.pri %1!push.pri!load.s.pri %2!pop.alt!",
        "load.s.pri %2!load.alt %1!", seqsize(4, 2) - seqsize(2, 2) },
    { "load.s.pri %1!push.pri!load.pri %2!pop.alt!",
        "load.pri %2!load.s.alt %1!", seqsize(4, 2) - seqsize(2, 2) },
    ...
    { "addr.pri %1!push.pri!load.s.pri %2!pop.alt!",
        "addr.alt %1!load.s.pri %2!", seqsize(4, 2) - seqsize(2, 2) },
     ...
     */
    { "move.pri!push.pri!load.s.pri %1!pop.alt!", "load.s.pri %1!",
        seqsize(4, 1) - seqsize(1, 1) },
    { "move.pri!push.pri!load.pri %1!pop.alt!", "load.pri %1!",
        seqsize(4, 1) - seqsize(1, 1) },
    { "move.pri!push.pri!const.pri %1!pop.alt!", "const.pri %1!",
        seqsize(4, 1) - seqsize(1, 1) },
     ...
     *    sgrtr                   ;$exp       (occurs for non-chained
     * comparisons) jzer n1                 -
     *    ;$exp                   -
     *    --------------------------------------
     *    xchg                    sless       also for sless, sgeq and sleq
    ...
    { "xchg!sleq!swap.alt!and!pop.alt!jzer %1!", "sgeq!pop.alt!and!jzer %1!",
        seqsize(5, 0) - seqsize(3, 0) },
    { "xchg!sgrtr!jzer %1!;$exp!", "jsgeq %1!;$exp!",
        seqsize(3, 1) - seqsize(1, 1) },
    { "xchg!sless!jzer %1!;$exp!", "jsleq %1!;$exp!",
        seqsize(3, 1) - seqsize(1, 1) },
    { "xchg!sgeq!jzer %1!;$exp!", "jsgrtr %1!;$exp!",
        seqsize(3, 1) - seqsize(1, 1) },
    { "xchg!sleq!jzer %1!;$exp!", "jsless %1!;$exp!",
        seqsize(3, 1) - seqsize(1, 1) },
    ...
    { "load.pri %1!load.s.alt %2!xchg!", "load.s.pri %2!load.alt %1!",
        seqsize(3, 2) - seqsize(2, 2) },
    { "load.pri %1!load.alt %2!xchg!", "load.pri %2!load.alt %1!",
        seqsize(3, 2) - seqsize(2, 2) },
    { "load.pri %1!const.alt %2!xchg!", "const.pri %2!load.alt %1!",
        seqsize(3, 2) - seqsize(2, 2) },
    { "const.pri %1!load.s.alt %2!xchg!", "load.s.pri %2!const.alt %1!",
        seqsize(3, 2) - seqsize(2, 2) },
    { "const.pri %1!load.alt %2!xchg!", "load.pri %2!const.alt %1!",
        seqsize(3, 2) - seqsize(2, 2) },
     ...
     */
    { "move.alt!const.pri %1!xchg!", "const.alt %1!",
        seqsize(3, 1) - seqsize(1, 1) },
    { "move.alt!load.pri %1!xchg!", "load.alt %1!",
        seqsize(3, 1) - seqsize(1, 1) },
    { "move.alt!load.s.pri %1!xchg!", "load.s.alt %1!",
        seqsize(3, 1) - seqsize(1, 1) },
    /* ----- */
 ...
 */
    ...
    { "addr.pri %1!push.pri!load.s.pri %2!bounds %3!shl.c.pri "
      "2!pop.alt!add!load.i!",
        "addr.alt %1!load.s.pri %2!bounds %3!lidx!",
        seqsize(8, 4) - seqsize(4, 3) },
    { "const.pri %1!push.pri!load.s.pri %2!bounds %3!shl.c.pri "
      "2!pop.alt!add!load.i!",
    ...
    { "addr.pri %1!push.pri!load.s.pri %2!shl.c.pri %3!pop.alt!add!load.i!",
        "addr.alt %1!load.s.pri %2!lidx.b %3!", seqsize(7, 3) - seqsize(3, 3) },
    { "const.pri %1!push.pri!load.s.pri %2!shl.c.pri %3!pop.alt!add!load.i!",
        "const.alt %1!load.s.pri %2!lidx.b %3!", seqsize(7, 3) - seqsize(3, 3) },
#if !defined BIT16
    ...
    { "addr.pri %1!push.pri!load.s.pri %2!shl.c.pri %3!pop.alt!add!",
        "addr.alt %1!load.s.pri %2!idxaddr.b %3!", seqsize(6, 3) - seqsize(3, 3) },
    { "const.pri %1!push.pri!load.s.pri %2!shl.c.pri %3!pop.alt!add!",
        "const.alt %1!load.s.pri %2!idxaddr.b %3!", seqsize(6, 3) - seqsize(3, 3) },
#if !defined BIT16
    /* the shorter array indexing sequences, see above for comments */
    { "shl.c.pri 2!pop.alt!add!loadi!", "pop.alt!lidx!",
        seqsize(4, 1) - seqsize(2, 0) },
    { "shl.c.pri 2!pop.alt!add!", "pop.alt!idxaddr!",
        seqsize(3, 1) - seqsize(2, 0) },
#endif
    { "shl.c.pri %1!pop.alt!add!loadi!", "pop.alt!lidx.b %1!",
        seqsize(4, 1) - seqsize(2, 1) },
    { "shl.c.pri %1!pop.alt!add!", "pop.alt!idxaddr.b %1!",
    ...
    { ";$lcl %1 %2!stack -4!const.pri %3!stor.s.pri %2!;$exp!",
        ";$lcl %1 %2!push.c %3!;$exp!", seqsize(3, 3) - seqsize(1, 1) },
    { ";$lcl %1 %2!stack -4!zero.pri!stor.s.pri %2!;$exp!",
        ";$lcl %1 %2!push.c 0!;$exp!", seqsize(3, 2) - seqsize(1, 1) },
     ...
     * so add another two cases.
     */
    { "push.pri!load.s.pri %1!pop.alt!", "move.alt!load.s.pri %1!",
        seqsize(3, 1) - seqsize(2, 1) },
    { "push.pri!load.pri %1!pop.alt!", "move.alt!load.pri %1!",
        seqsize(3, 1) - seqsize(2, 1) },
    { "push.pri!const.pri %1!pop.alt!", "move.alt!const.pri %1!",
        seqsize(3, 1) - seqsize(2, 1) },
    { "push.pri!zero.pri!pop.alt!", "move.alt!zero.pri!",
        seqsize(3, 0) - seqsize(2, 0) },
    /* saving PRI and then loading from its address
     * occurs when indexing a multi-dimensional array
     */
    { "push.pri!load.i!pop.alt!", "move.alt!load.i!",
        seqsize(3, 0) - seqsize(2, 0) },
     ...
     */
    { "move.alt!load.s.pri %1!add!", "load.s.alt %1!add!",
        seqsize(3, 1) - seqsize(2, 1) },
    { "move.alt!load.pri %1!add!", "load.alt %1!add!",
        seqsize(3, 1) - seqsize(2, 1) },
    { "move.alt!const.pri %1!add!", "const.alt %1!add!",
        seqsize(3, 1) - seqsize(2, 1) },
    { "move.alt!load.s.pri %1!sub.alt!", "load.s.alt %1!sub!",
        seqsize(3, 1) - seqsize(2, 1) },
    { "move.alt!load.pri %1!sub.alt!", "load.alt %1!sub!",
        seqsize(3, 1) - seqsize(2, 1) },
    { "move.alt!const.pri %1!sub.alt!", "const.alt %1!sub!",
        seqsize(3, 1) - seqsize(2, 1) },
     ...
     *    push.pri                -
     *    push.alt                -
     * A similar sequence occurs with the two PUSH.pri/alt instructions
     * inverted. The first, second, or both CONST.pri/alt instructions can also
     * be LOAD.pri/alt. This gives 2 x 4 cases.
     */
     ...
     */
    { "load.s.pri %1!push.pri!;$par!", "push.s %1!;$par!",
        seqsize(2, 1) - seqsize(1, 1) },
    { "load.pri %1!push.pri!;$par!", "push %1!;$par!",
        seqsize(2, 1) - seqsize(1, 1) },
    { "const.pri %1!push.pri!;$par!", "push.c %1!;$par!",
        seqsize(2, 1) - seqsize(1, 1) },
    { "zero.pri!push.pri!;$par!", "push.c 0!;$par!",
        seqsize(2, 0) - seqsize(1, 1) },
    { "addr.pri %1!push.pri!;$par!", "push.adr %1!;$par!",
        seqsize(2, 1) - seqsize(1, 1) },
     ...
     *    sub                     -
     */
    { "const.pri %1!load.s.alt %2!sub!", "load.s.pri %2!add.c -%1!",
        seqsize(3, 2) - seqsize(2, 2) },
    { "const.pri %1!load.alt %2!sub.alt!", "load.pri %2!add.c -%1!",
        seqsize(3, 2) - seqsize(2, 2) },
    /* With arrays indexed with constants that come from enumerations, it
     * happens multiple add.c opcodes follow in sequence. add.c n1 add.c n1+n2
     *    add.c n2                -
     */
    ...
    { "sless!jnz %1!", "jsless %1!", seqsize(2, 1) - seqsize(1, 1) },
    { "sleq!jzer %1!", "jsgrtr %1!", seqsize(2, 1) - seqsize(1, 1) },
    { "sleq!jnz %1!", "jsleq %1!", seqsize(2, 1) - seqsize(1, 1) },
    { "sgrtr!jzer %1!", "jsleq %1!", seqsize(2, 1) - seqsize(1, 1) },
    { "sgrtr!jnz %1!", "jsgrtr %1!", seqsize(2, 1) - seqsize(1, 1) },
    { "sgeq!jzer %1!", "jsless %1!", seqsize(2, 1) - seqsize(1, 1) },
    { "sgeq!jnz %1!", "jsgeq %1!", seqsize(2, 1) - seqsize(1, 1) },
     ...
     * and decrements.
     */
    { "inc %1!load.pri %1!;$exp!", "inc %1!;$exp!",
        seqsize(2, 2) - seqsize(1, 1) },
    { "load.pri %1!inc %1!;$exp!", "inc %1!;$exp!",
        seqsize(2, 2) - seqsize(1, 1) },
    { "inc.s %1!load.s.pri %1!;$exp!", "inc.s %1!;$exp!",
        seqsize(2, 2) - seqsize(1, 1) },
    { "load.s.pri %1!inc.s %1!;$exp!", "inc.s %1!;$exp!",
        seqsize(2, 2) - seqsize(1, 1) },
    { "dec %1!load.pri %1!;$exp!", "dec %1!;$exp!",
        seqsize(2, 2) - seqsize(1, 1) },
    { "load.pri %1!dec %1!;$exp!", "dec %1!;$exp!",
        seqsize(2, 2) - seqsize(1, 1) },
    { "dec.s %1!load.s.pri %1!;$exp!", "dec.s %1!;$exp!",
        seqsize(2, 2) - seqsize(1, 1) },
    { "load.s.pri %1!dec.s %1!;$exp!", "dec.s %1!;$exp!",
        seqsize(2, 2) - seqsize(1, 1) },
     ...
     * time, but anyway...
     */
    { "const.pri 0!stor.pri %1!;$exp!", "zero %1!;$exp!",
        seqsize(2, 2) - seqsize(1, 1) },
    { "const.pri 0!stor.s.pri %1!;$exp!", "zero.s %1!;$exp!",
        seqsize(2, 2) - seqsize(1, 1) },
    { "zero.pri!stor.pri %1!;$exp!", "zero %1!;$exp!",
        seqsize(2, 1) - seqsize(1, 1) },
    { "zero.pri!stor.s.pri %1!;$exp!", "zero.s %1!;$exp!",
        seqsize(2, 1) - seqsize(1, 1) },
     ...
     */
    { "push.c %1!;$par!push.c %2!;$par!push.c %3!;$par!push.c %4!;$par!push.c "
      "%5!;$par!",
        "push5.c %1 %2 %3 %4 %5!", seqsize(5, 5) - seqsize(1, 5) },
    { "push.c %1!;$par!push.c %2!;$par!push.c %3!;$par!push.c %4!;$par!",
        "push4.c %1 %2 %3 %4!", seqsize(4, 4) - seqsize(1, 4) },
    { "push.c %1!;$par!push.c %2!;$par!push.c %3!;$par!", "push3.c %1 %2 %3!",
        seqsize(3, 3) - seqsize(1, 3) },
    { "push.c %1!;$par!push.c %2!;$par!", "push2.c %1 %2!",
        seqsize(2, 2) - seqsize(1, 2) },
    /* ----- */
    { "push %1!;$par!push %2!;$par!push %3!;$par!push %4!;$par!push %5!;$par!",
        "push5 %1 %2 %3 %4 %5!", seqsize(5, 5) - seqsize(1, 5) },
    { "push %1!;$par!push %2!;$par!push %3!;$par!push %4!;$par!",
        "push4 %1 %2 %3 %4!", seqsize(4, 4) - seqsize(1, 4) },
    { "push %1!;$par!push %2!;$par!push %3!;$par!", "push3 %1 %2 %3!",
        seqsize(3, 3) - seqsize(1, 3) },
    { "push %1!;$par!push %2!;$par!", "push2 %1 %2!",
        seqsize(2, 2) - seqsize(1, 2) },
    /* ----- */
    { "push.s %1!;$par!push.s %2!;$par!push.s %3!;$par!push.s %4!;$par!push.s "
      "%5!;$par!",
        "push5.s %1 %2 %3 %4 %5!", seqsize(5, 5) - seqsize(1, 5) },
    { "push.s %1!;$par!push.s %2!;$par!push.s %3!;$par!push.s %4!;$par!",
        "push4.s %1 %2 %3 %4!", seqsize(4, 4) - seqsize(1, 4) },
    { "push.s %1!;$par!push.s %2!;$par!push.s %3!;$par!", "push3.s %1 %2 %3!",
        seqsize(3, 3) - seqsize(1, 3) },
    { "push.s %1!;$par!push.s %2!;$par!", "push2.s %1 %2!",
        seqsize(2, 2) - seqsize(1, 2) },
    /* ----- */
    { "push.adr %1!;$par!push.adr %2!;$par!push.adr %3!;$par!push.adr "
      "%4!;$par!push.adr %5!;$par!",
        "push5.adr %1 %2 %3 %4 %5!", seqsize(5, 5) - seqsize(1, 5) },
    { "push.adr %1!;$par!push.adr %2!;$par!push.adr %3!;$par!push.adr %4!;$par!",
        "push4.adr %1 %2 %3 %4!", seqsize(4, 4) - seqsize(1, 4) },
    { "push.adr %1!;$par!push.adr %2!;$par!push.adr %3!;$par!",
        "push3.adr %1 %2 %3!", seqsize(3, 3) - seqsize(1, 3) },
    { "push.adr %1!;$par!push.adr %2!;$par!", "push2.adr %1 %2!",
        seqsize(2, 2) - seqsize(1, 2) },
     ...
     *    load.s.pri n1           -
     */
    { "load.pri %1!load.alt %2!", "load.both %1 %2!",
        seqsize(2, 2) - seqsize(1, 2) },
    { "load.alt %2!load.pri %1!", "load.both %1 %2!",
        seqsize(2, 2) - seqsize(1, 2) },
    { "load.s.pri %1!load.s.alt %2!", "load.s.both %1 %2!",
        seqsize(2, 2) - seqsize(1, 2) },
    { "load.s.alt %2!load.s.pri %1!", "load.s.both %1 %2!",
        seqsize(2, 2) - seqsize(1, 2) },
     ...
     *    push.alt                -
     */
    { "load.both %1 %2!push.pri!push.alt!", "push2 %1 %2!",
        seqsize(3, 2) - seqsize(1, 2) },
    { "load.s.both %1 %2!push.pri!push.alt!", "push2.s %1 %2!",
        seqsize(3, 2) - seqsize(1, 2) },
     ...
     *    stor.s.pri n2           -
     */
    { "const.pri %1!stor.pri %2!", "const %2 %1!",
        seqsize(2, 2) - seqsize(1, 2) },
    { "const.pri %1!stor.s.pri %2!", "const.s %2 %1!",
        seqsize(2, 2) - seqsize(1, 2) },
    /* ----- */
    { NULL, NULL, 0 }
};
...
SC_FUNC void stgwrite(const char* st)
{
    ...
    if (staging) {
        assert(stgidx == 0 || stgbuf != NULL); /* staging buffer must be valid if there is
...
static int matchsequence(char* start,
    char* end,
    char* pattern,
...
static char* replacesequence(char* pattern,
    char symbols[MAX_OPT_VARS][MAX_ALIAS + 1],
    int* repl_length)
{
    char* lptr;
...
static void strreplace(char* dest,
    char* replace,
    int sub_length,
    int repl_length,
    int dest_length)
{
    ...
    if (offset > 0) { /* delete a section */
        ...
        memset(dest + dest_length - offset, 0xcc,
            ...
            while (start < end) {
                ...
                while (sequences[seq].find != NULL) {
                    ...
                    if (matchsequence(start, end, sequences[seq].find, symbols,
                        ...
                        /* If the replacement is bigger than the original section, we may
             * need to "grow" the staging buffer. This is quite complex, due to
             * the re-ordering of expressions that can also happen in the
             * staging buffer. In addition, it should not happen: the peephole
             * optimizer must replace sequences with *shorter* sequences, not
             * longer ones. So, I simply forbid sequences that are longer than
             * the ones they are meant to replace.
             */
