...
static char* errmsg[] = {
    ...
    /*030*/
    "compound statement not closed at the end of file (started at line %d)\n",
    ...
    /*056*/
    "arrays, local variables and function arguments cannot be public (variable "
    "\"%s\")\n",
    ...
    /*066*/
    "function argument may not be a reference argument or an array (argument "
    "\"%s\")\n",
    /*067*/
    ...
    /*083*/
    "a function or variable may only belong to a single automaton (symbol "
    "\"%s\")\n",
    /*084*/
    "state conflict: one of the states is already assigned to another "
    "implementation (symbol \"%s\")\n",
    /*085*/ "no states are defined for symbol \"%s\"\n",
    /*086*/ "unknown automaton \"%s\"\n",
    /*087*/ "unknown state \"%s\" for automaton \"%s\"\n",
    /*088*/
    "public variables and local variables may not have states (symbol "
    "\"%s\")\n",
    /*089*/ "state variables may not be initialized (symbol \"%s\")\n",
    /*090*/ "public functions may not return arrays (symbol \"%s\")\n",
    /*091*/ "ambiguous constant; tag override is required (symbol \"%s\")\n",
    /*092*/
    "functions may not return arrays of unknown size (symbol \"%s\")\n"
};
...
static char* warnmsg[] = {
    ...
    /*229*/
    "index tag mismatch (symbol \"%s\"): expected tag %s but found %s\n",
    /*230*/
    "no implementation for state \"%s\" in function \"%s\", no fall-back\n",
    ...
    if (strlen(errfname) == 0) {
        ...
        if (fp != NULL) {
            if (errstart >= 0 && errstart != errline)
                fprintf(fp, "%s(%d -- %d) : %s %03d: ", inpfname, errstart, errline,
                    pre, number);
            else
